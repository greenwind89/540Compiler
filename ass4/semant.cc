...
void program_class::semant()
{
  ...
  //  dump_line(stream,n,this);
    ...
    if(!checkDependentGraph){
      tree_node *tree=classes->nth(errorIndex)->copy();
      class__class *classItem=(class__class*)tree;
      cout<<"Inheritance graph error in class "<<classItem->name<<", line number "<<tree->get_line_number()<<" in file "<<classItem->filename<<endl<<endl;
    }
